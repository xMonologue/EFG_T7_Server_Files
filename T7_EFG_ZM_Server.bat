@echo off
::///////////////////////////////////////////////////////////////////////
::///  	      EFG T7 Dedicated Server Configuration start-up file        ///
::///////////////////////////////////////////////////////////////////////
:://                                                                   //
...
start T7_EFG.exe -dedicated +set fs_game "%ModFolderName%" +set net_port "%GamePort%"  +set logfile 2 +exec %ServerFilename%
